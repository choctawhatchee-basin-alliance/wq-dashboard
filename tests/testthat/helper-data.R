...
waterbodies <- c("Allen", "Alligator", "Bass", "Big Red Fish", "Camp Creek", 
                 ...
                 "CBA Holmes Creek-3", "CBA Mullet Creek-1", "CBA Mullet Creek-2", "CBA Mullet Creek-3",
                 ...
                 "CBA Santa Rosa Sound-3", "CBA Santa Rosa Sound-4", "CBA Santa Rosa Sound-5", 
                 "CBA Santa Rosa Sound-6", "CBA Santa Rosa Sound-7", "CBA Santa Rosa Sound-8", 
                 "CBA TKY-1", "CBA TKY-2", "CBA TKY-3", "Deer", "Draper", "Eastern", "Eastern North", 
                 "Fuller", "Grayton", "Little Red Fish", "Morris", "Oyster", "Powell", "Roberts", 
                 "Stallworth", "Swift Creek-1", "Swift Creek-2", "Swift Creek-3", "Swift Creek-4", 
